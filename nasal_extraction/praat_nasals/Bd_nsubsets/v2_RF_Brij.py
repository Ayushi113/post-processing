...
with open('/home/nash/ayushi/Projects_2016/nasals_Jan16/scripts/python_postproc/nasal_extraction/praat_nasals/Bd_nsubsets/Bd_n_reshape.csv') as fil:
     for line in fil.read().splitlines():
         sp = line.split(',')
         print sp
 	 feat_vector = sp[2:12]#+ [dir_array[sp[13]]]
