...
infile = open('/home/nash/ayushi/Projects_2016/nasals_Jan16/scripts/python_postproc/nasal_extraction/praat_nasals/deb_nsubsets/deb_f.csv', 'r').readlines()
...
with open('nasals_praat_deb.csv', 'w') as csvfile:
